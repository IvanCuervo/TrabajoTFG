...
data = pd.read_csv(
    "/DatosGenes/ScienceADG/DatosCodificadosSinAmbiguoEnteros.csv",
    delimiter=';',
    names=["UnitProtein", "Position", "Pathogenic", "Actual_A", "Actual_C", "Actual_D", "Actual_E", "Actual_F", "Actual_G", "Actual_H", "Actual_I", "Actual_K", "Actual_L", "Actual_M", "Actual_N", "Actual_P", "Actual_Q", "Actual_R", "Actual_S", "Actual_T", "Actual_V", "Actual_W", "Actual_Y", "Change_A", "Change_C", "Change_D", "Change_E", "Change_F", "Change_G", "Change_H", "Change_I", "Change_K", "Change_L", "Change_M", "Change_N", "Change_P", "Change_Q", "Change_R", "Change_S", "Change_T", "Change_V", "Change_W", "Change_Y"]
)
